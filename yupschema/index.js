...
export const loginSchema =  Yup.object({
    email: Yup.string().min(7).required("Please enter email"),
  ...
  confirmpassword: Yup.string().required("Please confirm password").oneOf([Yup.ref('newpassword'), null], 'Confirm Password does not match with password'),
  })