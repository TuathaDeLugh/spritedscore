...

      {
        ...
        reviews?.map((review) => {
          return (
            ...
            <div key={review._id} className="flex flex-wrap overflow-hidden bg-white rounded-lg shadow-lg dark:shadow-gray-700/50 dark:bg-slate-800 mb-5 border dark:border-slate-600">
              <div className="w-full h-60 md:h-auto  md:w-1/2 bg-cover" style={{ backgroundImage: `url(${review.image.link})`, backgroundPosition: "center center" }}>
