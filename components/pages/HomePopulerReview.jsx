...
export default async function HomePopulerReview() {
	...
	return (
		<>
			...
			<div className="overflow-auto pr-5 flex flex-wrap justify-between">
			{reviews?.map(review => {
				return (

			<Link href={`/allreview/${review._id}`} key={review._id}
  class="inline-block w-[45%] mb-5 rounded-lg bg-slate-50 shadow hover:border-purple-500 dark:hover:border-purple-400 dark:shadow-gray-600 dark:bg-slate-800 border dark:border-gray-600">
