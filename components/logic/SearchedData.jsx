    ...
    <div className="flex max-h-80 overflow-y-auto pr-2">
        {
            ...
            (<p>No Review Avaliable Named : <span className='text-purple-500'> {query} </span></p>):(
...

                {
                    reviews?.map((review) =>
                    (
                        <Link href={`/allreview/${review._id}`} className=" flex w-full items-center p-2 border border-slate-300 dark:border-slate-500 hover:border-purple-500 dark:hover:border-purple-400 hover:bg-purple-200 dark:hover:bg-purple-800/50  rounded-md mb-2 ">
