...
export default function Darkmode ({ children}) {
  ...
  return (
    <div className={isDarkMode ? 'dark' : ''}>
      {/* Your components */}
      {children}
        <div className=' text-white fixed bottom-10 right-0 px-1 border border-slate-300 dark:border-slate-700 shadow-sm shadow-slate-600 backdrop-blur p-1 rounded-l-full'>
