						...
						<ul className='h-screen md:h-auto items-center justify-center md:flex '>
							{navData.map(link => {
								return (
									<li
										key={link.key}
										className='text-l text-slate-800 dark:text-slate-300 py-5 px-5 text-center  border-b-2 md:border-b-0  border-slate-400  md:hover:text-purple-700 md:dark:hover:text-purple-400 md:hover:bg-transparent'
									>
										<Link
