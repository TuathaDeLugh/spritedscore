        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white dark:bg-slate-900 px-10 py-10 sm:px-12 md:px-[60px]">
              ...
              <h2 className="text-center text-2xl md:text-3xl font-semibold dark:text-purple-400 m-auto mb-6">Create An Account</h2>
              <form>
              <InputBox type="text" name="name" placeholder="Name"/>
              <InputBox type="text" name="username" placeholder="Username" />
                <InputBox type="email" name="email" placeholder="Email" />
              <InputBox type="text" name="name" placeholder="Image"/>
