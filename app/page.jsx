	...
	return (
		<div className='px-2 mx-auto max-w-[1500px]'>
			...
			<div className='container px-6 md:px-0 py-3 mx-auto flex flex-wrap items-start'>
				<div className='scrollbar-hidden md:h-[100vh] xl:h-auto overflow-auto w-full md:w-2/3 md:pr-5 md:sticky top-[72px]  '>
					
					<HomeLetestReview />
					
				</div>
				<div className=' scrollbar-hidden md:h-[100vh] xl:h-auto overflow-auto md:border-l dark:border-gray-500 mt-5 md:mt-0 md:sticky top-5 md:pl-5 w-full md:w-1/3'>
      				<HomePopulerReview />
				</div>
			</div>
			</Suspense>
